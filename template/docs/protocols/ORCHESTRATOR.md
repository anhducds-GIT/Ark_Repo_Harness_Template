...
2. Mọi tên gói sản phẩm của repo gốc, và mọi tên khoá vùng gõ cứng (_root, _docs, _code,
   _template) — bộ khung chạy ở repo khai vùng khác, một tên gõ cứng ở đó trỏ vào hư không mà
   không ai phát hiện.
...
Ba dòng trên **cố ý viết ra đúng những chuỗi bị cấm** — mã việc ở dòng 1, tên khoá vùng ở dòng
2. Phép kiểm ở tầng mã nguồn canh sổ tay này bỏ qua khối chú thích HTML trước khi dò; nếu chú
thích không chứa chuỗi cấm nào thì nhánh "bỏ chú thích" không bao giờ chạy tới, và nó chỉ là đồ
trang trí. Đột biến kiểm đã bắt đúng chỗ đó. Đừng "dọn cho sạch" ba dòng này.

**Một ngoại lệ, và đừng khôi phục nó:** ba tên gói sản phẩm của repo gốc từng được kể thẳng ở
dòng 2, nay đã bỏ. Từ bản 1.3.0 file này ĐI THEO bản trích, mà bộ trích có một cổng chặn mọi
file mang tên dự án gốc sang repo khác. Kể tên ở đây làm cổng đó đỏ và **không phát hành được**
— đã đo thật 05/09. Dòng 2 vẫn còn tên khoá vùng, nên nhánh "bỏ chú thích" vẫn có việc để làm.
