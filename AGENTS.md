...
| **Giao việc NÂNG BỘ KHUNG cho một AI khác** (Codex, GPT…) | [docs/briefs/NANG-BO-KHUNG.md](docs/briefs/NANG-BO-KHUNG.md) — **dán trọn, đừng tóm tắt hộ**. Chín mục, mỗi mục một checklist chạy được: nhận quyền · đọc bảng `--plan` (**hai trạng thái bắt DỪNG**) · khai lệnh và file mới · thứ tự commit nguồn-trước-artifact-sau · cổng đóng phiên · **hai lượt đẩy** · bốn việc không được tự làm · mẫu báo cáo năm dòng. **Đức chốt 06/09**: Claude Code không làm hết một mình được, nên việc lặp lại và đo được bằng máy phải giao được cho AI khác |
