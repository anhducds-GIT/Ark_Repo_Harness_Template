...
| **Biết việc đang mở được xếp thứ tự thế nào, việc nào chạy song song được** | [docs/ROADMAP-V2.md](docs/ROADMAP-V2.md) — lớp ĐIỀU PHỐI: thứ tự · phân luồng theo khoá · phụ thuộc · chỗ chờ người chốt. **Cố ý không chứa nội dung từng mục nợ** (ở [BACKLOG.md](BACKLOG.md)), không chứa ngày tháng, không chứa bản vá kỹ thuật |
