...
| **Tra một lượt bàn giao CŨ, hoặc một bản phát CŨ** | [docs/archive/](docs/archive/HANDOFF-2026-09.md) — kho **LƯU TRỮ**: [nhật ký 2026-09 phần đầu](docs/archive/HANDOFF-2026-09.md) · [sổ phát hành 0.1.0→1.2.20](docs/archive/CHANGELOG-0.1.0-1.2.20.md) · [ROADMAP-V1](docs/archive/ROADMAP-V1.md). **Chữ giữ nguyên từng dòng, chỉ đổi chỗ** — file chỉ-thêm phình vô hạn trong một ngân sách cố định, nên phải cất gọn. Thư mục này **KHÔNG tính vào ngân sách tài liệu** (`can-nang.mjs` miễn nó): ngân sách đo thứ MỌI phiên phải nạp, mà lưu trữ theo định nghĩa là thứ không nạp mỗi lần. Cất vào đây thì **đừng sửa**, nó là lịch sử |
