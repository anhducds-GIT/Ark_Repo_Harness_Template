# CHANGELOG — LƯU TRỮ, bản 0.1.0 → 1.2.20

> **CHỮ GIỮ NGUYÊN, chỉ ĐỔI CHỖ.** Cắt từ `CHANGELOG.md` ngày 2026-09-06.
> Sổ phát hành là file CHỈ-THÊM, nên nó phình vô hạn — 806 dòng trong một ngân sách cố
> định 2.200 dòng cho toàn bộ tài liệu. Không khối nào bị sửa, không khối nào bị bỏ.
> Bản mới nhất vẫn ở [CHANGELOG.md](../../CHANGELOG.md).
