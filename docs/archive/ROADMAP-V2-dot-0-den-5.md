# ROADMAP V2 — KẾ HOẠCH SÁU ĐỢT, LƯU TRỮ

**Dời 09/09.** Khối này đã bị hai khối *Cập nhật* (05/09 và 06/09) ở đầu
[ROADMAP-V2.md](../ROADMAP-V2.md) phủ lên — chính file đó ghi *"mục này thay phần xếp đợt bên
dưới ở những chỗ mâu thuẫn"*. Một file nói hai thứ tự rồi dặn đọc cái nào trước chính là hình
dạng nhiễu mà bộ biên dịch luật ([ADR-0014](adr/0014-bo-bien-dich-luat.md)) sinh ra để cắt.

Đo lúc dời: **7 trong 13** mã việc nhắc ở đây đã đóng. Chữ giữ nguyên từng byte, chỉ đổi chỗ.
